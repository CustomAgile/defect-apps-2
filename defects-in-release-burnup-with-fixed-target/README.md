#TS Fixed Target Release Burnup

A release defect chart by sprint.

The x axis is sprint in the release, up to the current sprint (if release is in progress).
...
Series:
  ...
  * Fixed in Release:  At the end of every sprint (or today if the current sprint), count the number of defects that ARE in a closed state that closed during the sprint.
